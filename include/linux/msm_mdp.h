...
#define MDP_SOLID_FILL 0x0000100   /*20131119 tracy add for fix screen will flash after press video icon to start/end a video call in Hangouts.*/
...
struct mdp_blit_req {
	...
	struct color const_color;  //tracy test
	uint32_t alpha;
